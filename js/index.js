$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*hi,我的名字叫张松林，是上海一家互联网创业公司的前端工程师</div>");
	...
	w.load("<p><div class='writecode'>张松林</div>");
	w.load("<div class='writecode'>前端工程师(泽忆科技有限公司)</div>");
	...
	c.load("<div class='comment writecode'>&nbsp;*QQ/微信:1336434510/w1336434510</div>");
	c.load("<div class='comment writecode'>&nbsp;*mobile:13147060550</div>");
